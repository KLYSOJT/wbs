...
/**
 * Save or update REDCROSS module to Supabase (with file)
 */
async function saveMemoToSupabase(data) {
  try {
    ...
    console.log('Saving REDCROSS module:', data.title);
    ...
    console.log('✓ REDCROSS module saved to Supabase:', data.title);
    return result ? result[0] : data;
  } catch (error) {
    console.error('Error saving REDCROSS module to Supabase:', error.message);
    throw error;
  }
}

/**
 * Load all REDCROSS from Supabase
 */
async function loadMemosFromSupabase() {
  try {
    ...
    console.error('Error loading REDCROSS module from Supabase:', error.message);
    return [];
  }
}

/**
 * Delete REDCROSS from Supabase
 */
async function deleteMemoFromSupabase(id, fileUrl) {
  try {
    ...
    console.log('✓ REDCROSS module deleted from Supabase');
    return true;
  } catch (error) {
    console.error('Error deleting REDCROSS module from Supabase:', error.message);
    return false;
  }
}
