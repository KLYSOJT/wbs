// ==================== INDEXEDDB SETUP FOR PROCUREMENT REPORT ====================
const DB_NAME = 'WBSSDatabase_ProcurementReport';
const DB_VERSION = 1;
const STORE_NAME = 'procurement_report';
const FILE_STORE_NAME = 'procurement_reportFiles';
...
function initIndexedDB() {
  return new Promise((resolve, reject) => {
    ...
    request.onupgradeneeded = (event) => {
      ...
      // Create procurement_report store
...
/**
 * Save or update Procurement Report module to Supabase (with file)
 */
async function saveMemoToSupabase(data) {
  try {
    ...
    console.log('Saving Procurement Report module:', data.title);
    ...
    console.log('✓ Procurement Report module saved to Supabase:', data.title);
    return result ? result[0] : data;
  } catch (error) {
    console.error('Error saving Procurement Report module to Supabase:', error.message);
    throw error;
  }
}

/**
 * Load all Procurement Report from Supabase
 */
async function loadMemosFromSupabase() {
  try {
    ...
    console.error('Error loading Procurement Report module from Supabase:', error.message);
    return [];
  }
}
...
async function deleteMemoFromSupabase(id, fileUrl) {
  try {
    ...
    console.log('✓ Procurement Report module deleted from Supabase');
    return true;
  } catch (error) {
    console.error('Error deleting Procurement Report module from Supabase:', error.message);
    return false;
  }
}
