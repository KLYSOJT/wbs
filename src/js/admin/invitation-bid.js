// ==================== INDEXEDDB SETUP FOR INVITATION BID ====================
const DB_NAME = 'WBSSDatabase_InvitationBid';
const DB_VERSION = 1;
const STORE_NAME = 'invitation_bid';
const FILE_STORE_NAME = 'invitation_bidFiles';
...
/**
 * Save or update Invitation Bid module to Supabase (with file)
 */
async function saveMemoToSupabase(data) {
  try {
    ...
    console.log('Saving Invitation Bid module:', data.title);
    ...
    console.log('✓ Invitation Bid module saved to Supabase:', data.title);
    return result ? result[0] : data;
  } catch (error) {
    console.error('Error saving Invitation Bid module to Supabase:', error.message);
    throw error;
  }
}

/**
 * Load all Invitation Bid from Supabase
 */
async function loadMemosFromSupabase() {
  try {
    ...
    console.error('Error loading Invitation Bid module from Supabase:', error.message);
    return [];
  }
}

/**
 * Delete Invitation Bid from Supabase
 */
async function deleteMemoFromSupabase(id, fileUrl) {
  try {
    ...
    console.log('✓ Invitation Bid module deleted from Supabase');
    return true;
  } catch (error) {
    console.error('Error deleting Invitation Bid module from Supabase:', error.message);
    return false;
  }
}
