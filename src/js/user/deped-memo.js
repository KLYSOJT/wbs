...
function renderPagination() {
  ...
  fragment.appendChild(
    createPaginationButton('Previous', depedMemoState.currentPage - 1, {
      isDisabled: depedMemoState.currentPage === 1,
      extraClass: 'pagination-btn--nav',
      ariaLabel: 'Previous page'
    })
  );

  buildPaginationItems(totalPages, depedMemoState.currentPage).forEach((item) => {
    if (item === 'ellipsis') {
    ...
    fragment.appendChild(
      createPaginationButton(String(item), item, {
        isActive: item === depedMemoState.currentPage,
        ariaLabel: 'Page ' + item
      })
    );
  });
  ...
  fragment.appendChild(
    createPaginationButton('Next', depedMemoState.currentPage + 1, {
      isDisabled: depedMemoState.currentPage === totalPages,
      extraClass: 'pagination-btn--nav',
      ariaLabel: 'Next page'
    })
  );
